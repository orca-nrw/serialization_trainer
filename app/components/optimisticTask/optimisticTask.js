...
function generateTask() {
    ...
    document.getElementById("optimisticTable").hidden = true;
...
function resolve() {
    ...
    for (let i = 0; i < numberOfTransactions; i++) {
        if (document.getElementById(scheduleManager.transactions[i].id + "yes").checked === true && scheduleManager.transactions[i].validationFailed === false) {
            correctAnswer = false;
            document.getElementById(scheduleManager.transactions[i].id + "CellYes").style.backgroundColor = "#f8d7da";
        } else if (document.getElementById(scheduleManager.transactions[i].id + "no").checked === true && scheduleManager.transactions[i].validationFailed === true) {
            correctAnswer = false;
    ...
    document.getElementById("optimisticTable").hidden = false;
